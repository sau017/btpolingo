...
import com.example.db.dbapp.util.SpringUtils;




@WebServlet(urlPatterns = { "/salesodata.svc/*" }

, initParams = {
		@WebInitParam(name = "javax.ws.rs.Application", value = "org.apache.olingo.odata2.core.rest.app.ODataApplication"),
		@WebInitParam(name = "org.apache.olingo.odata2.service.factory", value = "com.example.db.dbapp.processor.MyODataProcessor") 
		}
...
public class BuilderODataServlet extends ODataServlet {
	...
	private String oDataServiceFactoryBeanName = " com.example.db.dbapp.processor.MyODataServiceFactory" ;
