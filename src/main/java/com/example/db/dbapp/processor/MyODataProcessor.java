package com.example.db.dbapp.processor;
...
public class MyODataProcessor extends DataSourceProcessor {
    ...
    public ODataResponse readEntitySet(final GetEntitySetUriInfo uriInfo, final String contentType)
        ...
        if (data.size() > SERVER_PAGING_SIZE) {
            ...
            nextLink = context.getPathInfo().getServiceRoot().relativize(context.getPathInfo().getRequestUri())
                    .toString();
    ...
    public ODataResponse readEntity(final GetEntityUriInfo uriInfo, final String contentType) throws ODataException {
        ...
        final ExpandSelectTreeNode expandSelectTreeNode = UriParser.createExpandSelectTree(uriInfo.getSelect(),
                uriInfo.getExpand());
        ODataResponse odr = ODataResponse
    ...
    public ODataResponse createEntity(final PostUriInfo uriInfo, final InputStream content,
        ...
        if (!navigationSegments.isEmpty()) {
            ...
            dataSource.writeRelation(previousEntitySet, sourceData, entitySet,
    ...
    public ODataResponse deleteEntityLink(final DeleteUriInfo uriInfo, final String contentType) throws ODataException {
        ...
        final EdmEntitySet entitySet = previousSegments.isEmpty() ? uriInfo.getStartEntitySet()
                : previousSegments.get(previousSegments.size() - 1).getEntitySet();
    ...
    public ODataResponse readEntitySimplePropertyValue(final GetSimplePropertyUriInfo uriInfo, final String contentType)
        ...
        final Object value = property.getMapping() == null
                || property.getMapping().getMediaResourceMimeTypeKey() == null ? getPropertyValue(data, propertyPath)
                        : getSimpleTypeValueMap(data, propertyPath);
    ...
    public ODataResponse readEntityMedia(final GetMediaResourceUriInfo uriInfo, final String contentType)
        ...
        final String mimeType = binaryData.getMimeType() == null ? HttpContentType.APPLICATION_OCTET_STREAM
    ...
    public ODataResponse executeFunctionImport(final GetFunctionImportUriInfo uriInfo, final String contentType)
        ...
        if (type.getKind() == EdmTypeKind.SIMPLE) {
            value = type == EdmSimpleTypeKind.Binary.getEdmSimpleTypeInstance() ? ((BinaryData) data).getData() : data;
        ...
        final ODataResponse response = EntityProvider.writeFunctionImport(contentType, functionImport, value,
                entryProperties);
        ...
        if (functionImportParameters == null) {
            ...
            for (final String parameterName : functionImportParameters.keySet()) {
                ...
                parameterMap.put(parameterName,
                        type.valueOfString(literal.getLiteral(), EdmLiteralKind.DEFAULT, null, type
                                .getDefaultType()));
            }
            return parameterMap;
        }
        ...
        public WriteFeedCallbackResult retrieveFeedResult(final WriteFeedCallbackContext context)
            ...
            try {
                ...
                EntityProviderWriteProperties inlineProperties = EntityProviderWriteProperties
                        .serviceRoot(getContext().getPathInfo().getServiceRoot()).callbacks(
                                getCallbacks(relatedData, entityType))
